...
| `GET`    | `/movie-info/lists` | Get all movies information |
| `GET`   | `/movie-info/find-by-id/{movieIndoId}`      | Get movie path by ID     |
...
| `GET`  | `movie-stream/with-id/{movieInfoId}`        | Gets movie path from catelog service|
...
🔹 Home Page![Home](Docs/images/HomePage.png)
🔹 Video Player![Video](Docs/images/VideoPlayer.png)
🔹 Eureka Service![Eureka](Docs/images/Eureka.png)
